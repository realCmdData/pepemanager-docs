...
Dieser Befehl kann verwendet werden, um die Bildvorlage "Toiletten-Jetpack" über Benutzeravatare, Serversymbole, Emojis \(benutzerdefiniert oder Standard\) oder andere bereitgestellte Bildanhänge oder Bild-URLs zu legen.
...
```text
p!toiletjetpack [ImageURL/AttachedImage/Emoji/User/ServerID]
```
