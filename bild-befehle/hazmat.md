...
Dieser Befehl kann verwendet werden, um die Bildvorlage "Schutzanzug" über Benutzeravatare, Serversymbole, Emojis \(benutzerdefiniert oder Standard\) oder andere bereitgestellte Bildanhänge oder Bild-URLs zu legen.
...
```text
p!hazmat [ImageURL/AttachedImage/Emoji/User/ServerID]
```
