...
Dieser Befehl kann verwendet werden, um die Bildvorlage "Bonk" über Benutzeravatare, Serversymbole, Emojis \(benutzerdefiniert oder Standard\) oder andere bereitgestellte Bildanhänge oder Bild-URLs zu legen.
...
```text
p!bonk [ImageURL/AttachedImage/Emoji/User/ServerID]
```
