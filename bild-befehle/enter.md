...
Dieser Befehl kann verwendet werden, um die Bildvorlage "Eintreten" über Benutzeravatare, Serversymbole, Emojis \(benutzerdefiniert oder Standard\) oder andere bereitgestellte Bildanhänge oder Bild-URLs zu legen.
...
```text
p!enter [ImageURL/AttachedImage/Emoji/User/ServerID]
```
