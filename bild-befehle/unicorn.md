...
Dieser Befehl kann verwendet werden, um die Bildvorlage "Einhorn" über Benutzeravatare, Serversymbole, Emojis \(benutzerdefiniert oder Standard\) oder andere bereitgestellte Bildanhänge oder Bild-URLs zu legen.
...
```text
p!unicorn [ImageURL/AttachedImage/Emoji/User/ServerID]
```
