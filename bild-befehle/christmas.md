...
Dieser Befehl kann verwendet werden, um die Bildvorlage "Weihnachten" über Benutzeravatare, Serversymbole, Emojis \(benutzerdefiniert oder Standard\) oder andere bereitgestellte Bildanhänge oder Bild-URLs zu legen.
...
```text
p!chistmas [ImageURL/AttachedImage/Emoji/User/ServerID]
```
